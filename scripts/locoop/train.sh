...
--output-dir output/${DATASET}/${TRAINER}/${CFG}_${SHOTS}shots/nctx${NCTX}_csc${CSC}_ctp${CTP}/seed1 \
--lambda_value ${lambda} \
--topk ${topk} \
...
--dataset-config-file configs/datasets/${DATASET}.yaml \
--config-file configs/trainers/LoCoOp/${CFG}.yaml \
--output-dir output/${DATASET}/${TRAINER}/${CFG}_${SHOTS}shots/nctx${NCTX}_csc${CSC}_ctp${CTP}/seed2 \
--lambda_value ${lambda} \
--topk ${topk} \
TRAINER.LOCOOP.N_CTX ${NCTX} \
TRAINER.LOCOOP.CSC ${CSC} \
...
--dataset-config-file configs/datasets/${DATASET}.yaml \
--config-file configs/trainers/LoCoOp/${CFG}.yaml \
--output-dir output/${DATASET}/${TRAINER}/${CFG}_${SHOTS}shots/nctx${NCTX}_csc${CSC}_ctp${CTP}/seed3 \
--lambda_value ${lambda} \
--topk ${topk} \
TRAINER.LOCOOP.N_CTX ${NCTX} \
TRAINER.LOCOOP.CSC ${CSC} \
